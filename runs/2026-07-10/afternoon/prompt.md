...
```json
{
  ...
  "portfolio": {
    ...
    "totalEquity": 982229.0,
    "cash": 904009.0,
    "investedValue": 78220.0,
    "unrealizedPnl": -2892.0,
    "realizedPnl": -14879.0,
    "totalPnl": -17771.0,
    "totalReturnPct": -1.78,
    "positionsUsed": 2,
    ...
    "minCashPct": 0,
    "minCashValue": 0.0,
    "deployableCash": 904009.0
  },
  "market": {
    "timestamp": "2026-07-10T15:35:14.331176",
    "indices": {
      "上证指数": {
        "code": "sh000001",
        "close": 3996.162,
  ...
  "enriched_candidates": [
    {
      "code": "601126.SH",
      "fetch_time": "2026-07-10T15:35:14+0800",
      "name": "四方股份",
      "pe": 52.9582,
      "pb": 9.9441,
      "ps_ttm": 5.3319,
    ...
    {
      "code": "688536.SH",
      "fetch_time": "2026-07-10T15:35:16+0800",
      "name": "思瑞浦",
      "pe": 162.3317,
      "pb": 6.7295,
      "ps_ttm": 17.6115,
    ...
    {
      "code": "688401.SH",
      "fetch_time": "2026-07-10T15:35:18+0800",
      "name": "路维光电",
      "pe": 59.9192,
      "pb": 10.1733,
      "ps_ttm": 13.294,
    ...
    {
      "code": "002947.SZ",
      "fetch_time": "2026-07-10T15:35:19+0800",
      "name": "恒铭达",
      "pe": 31.4937,
      "pb": 5.8235,
      "ps_ttm": 6.1967,
    ...
    {
      "code": "688331.SH",
      "fetch_time": "2026-07-10T15:35:20+0800",
      "name": "荣昌生物",
      "pe": 58.5611,
      "pb": 19.2567,
      "ps_ttm": 22.3729,
  ...
  "active_positions": [
    {
      ...
      "stopLoss": 65.86,
      "currentStop": 65.86,
      "thesis": "军工电子MLCC龙头，Q1净利+71%，RPS加速上行(RPS20 97.21%)，短期回调至均线下方提供低吸机会，但10日走弱(仅超3.8%个股)需警惕",
      "sector": "军工电子Ⅱ",
      "rps120": 92.19,
      "catalysts": [],
      "shares": 400,
    ...
    },
    {
      ...
      "stopLoss": 50.71,
      "currentStop": 50.71,
      "thesis": "OLED蒸发机龙头，H1净利预增492-604%(7/5公告)，光学光电子板块前期强势现回调至MA20支撑(+2.0%)，催化剂极新鲜，设备业务放量驱动",
      "sector": "光学光电子",
      "rps120": 93.31,
      "catalysts": [],
      "shares": 1000,
  ...
  "entry_regime": {
    ...
    "hard_block": false,
    "reason": "Entry regime balanced: breadth 2.25:1, 0/3 major indices green, 95 limit-ups / 8 limit-downs. Allow normal sizing."
  },
  "rule_violations": {
    "status": "violations",
    "total_rules": 6,
        ...
        "violations": [
          {
            ...
            "days_held": 0,
            "pnl_pct": -4.01,
            "suggestion": "Down -4.0% after only 0 days. Possible entry during low-IV complacent market. Review: was IVRank<15% at entry? Was 5-day cum gain >6%? Consider tighter stop or faster exit for entries during low-IV regimes."
          }
        ],
        "error": null
      },
        ...
        "violations": [
          {
            ...
            "days_held": 0,
            "pnl_pct": -4.01,
            "suggestion": "Down -4.0% after only 0 days — likely overextended entry. Check: (1) Was 5-day cum gain >12% at entry? (LEARNINGS#13) (2) Was IV Rank <15% at entry? (LEARNINGS auto-update 03-03) (3) Was the stock up >8% on entry day? (LEARNINGS#10) Consider tighter stop or accelerated exit."
          }
        ],
        "error": null
      },
