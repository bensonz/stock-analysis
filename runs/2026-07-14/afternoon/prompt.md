...
```json
{
  ...
  "market": {
    "timestamp": "2026-07-14T15:35:13.360395",
    "indices": {
      "上证指数": {
        "code": "sh000001",
        "close": 3967.126,
  ...
  "enriched_candidates": [
    {
      "code": "002290.SZ",
      "fetch_time": "2026-07-14T15:35:13+0800",
      "name": "禾盛新材",
      "pe": 121.1676,
      "pb": 19.65,
      "ps_ttm": 7.5526,
      ...
      "iv_proxy": {
        ...
        "sizing": "tight",
        "guidance": "500ETF深 IV Rank 78.4% is very high; only take the strongest setups with wider stops.",
        "alternates": [
          {
            "underlying": "159919",
            "name": "300ETF深",
            "iv_rank": 0.6309,
            "iv_percentile": 0.7358
          },
          {
            "underlying": "159901",
            "name": "深100ETF",
            "iv_rank": 0.824,
            "iv_percentile": 0.9019
          }
        ]
      }
    },
    {
      ...
      "iv_proxy": {
        ...
        "interpretation": "极高 (市场恐慌，可能是超卖反弹机会)",
        "sizing": "tight",
        "guidance": "科创50 IV Rank 96.8% is very high; only take the strongest setups with wider stops.",
        "alternates": [
          {
            "underlying": "588080",
            "name": "科创板50",
    ...
    },
    {
      ...
      "iv_proxy": {
        ...
        "interpretation": "极高 (市场恐慌，可能是超卖反弹机会)",
        "sizing": "tight",
        "guidance": "深100ETF IV Rank 82.4% is very high; only take the strongest setups with wider stops.",
        "alternates": [
          {
            "underlying": "159919",
            "name": "300ETF深",
    ...
    },
    {
      ...
      "iv_proxy": {
        ...
        "primary_name": "创业板ETF",
        "iv_rank": 0.8872,
        "iv_percentile": 0.9202,
        "current_iv": 0.43,
        "interpretation": "极高 (市场恐慌，可能是超卖反弹机会)",
        "sizing": "tight",
        "guidance": "创业板ETF IV Rank 88.7% is very high; only take the strongest setups with wider stops.",
        "alternates": [
          {
            "underlying": "159922",
            "name": "500ETF深",
    ...
    {
      "code": "688295.SH",
      "fetch_time": "2026-07-14T15:35:15+0800",
      "name": "中复神鹰",
      "pe": 227.2726,
      "pb": 8.271,
      "ps_ttm": 16.5592,
    ...
    },
    {
      ...
      "events": [
        ...
        {
          "content": "公司发布股权激励计划预案，股价盘中上涨<span style=\"color:#FB475DC\"> 8.03% </span>",
          "tags": [
            "股价上涨"
          ]
        },
    ...
    },
    {
      ...
      "events": [
        ...
        {
          "content": "13:18 液冷服务器板块走高，飞龙股份、博杰股份涨停，日科化学盘中创新高，奥迪威、风华高科、凯添燃气、光迅科技跟涨。",
          "tags": [
            "快讯"
          ]
        },
    ...
    {
      "code": "688401.SH",
      "fetch_time": "2026-07-14T15:35:17+0800",
      "name": "路维光电",
      "pe": 60.1169,
      "pb": 10.2069,
      "ps_ttm": 13.3379,
    ...
    },
    {
      ...
      "iv_proxy": {
        ...
        "interpretation": "偏高 (市场谨慎，波动率偏贵)",
        "sizing": "selective",
        "guidance": "500ETF IV Rank 62.9% is elevated; be selective with new entries.",
        "alternates": [
          {
            "underlying": "510300",
            "name": "300ETF",
    ...
    {
      "code": "688502.SH",
      "fetch_time": "2026-07-14T15:35:18+0800",
      "name": "茂莱光学",
      "pe": 1673.767,
      "pb": 26.3915,
      "ps_ttm": 42.5035,
    ...
    {
      "code": "688469.SH",
      "fetch_time": "2026-07-14T15:35:19+0800",
      "name": "芯联集成-U",
      "pe": -144.9081,
      "pb": 5.481,
      "ps_ttm": 8.4539,
  ...
  "entry_regime": {
    ...
    "hard_block": false,
    "reason": "Entry regime strong: breadth 3.38:1, 3/3 major indices green, 89 limit-ups / 29 limit-downs. Allow entries at full size; per-stock overextension is filtered individually (dist_ma)."
  },
  "rule_violations": {
    "status": "ok",
    "total_rules": 6,
