# 运行审计 2026-09-08 noon

**结论: 🟡 需要人工操作**

_生成于 2026-09-09T12:19:17+08:00_
...
- `gate-hard-fail:phase1_to_phase2:a72fd359`
- position 601872 (招商轮船): price fetch error: all 3 sources failed: <urlopen error [Errno 8] nodename nor servname provided, or not known>
...
### [env] 数据健康告警: screening data is 1 session(s) stale (latest 2026-09-07, expected 2026

- `db-health-warning:50a825a4`
- screening data is 1 session(s) stale (latest 2026-09-07, expected 2026-09-08)
...
- spot_check: {"date": "2026-09-07", "sampled": 20, "checked": 0, "fetch_failures": 20, "mismatches": []}。0 处不一致来自 0 次比对，不能读作数据无误。
- **连续第 2 次**（始于 2026-09-07）
