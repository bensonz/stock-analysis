...
```json
{
  ...
  "market": {
    "timestamp": "2026-07-20T13:21:05.683391",
    "indices": {
      "上证指数": {
        "code": "sh000001",
        "close": 3793.372,
  ...
  "enriched_candidates": [
    {
      "code": "688777.SH",
      "fetch_time": "2026-07-20T13:21:05+0800",
      "name": "中控技术",
      "pe": 175.21,
      "pb": 7.0702,
      "ps_ttm": 8.7054,
    ...
    },
    {
      ...
      "events": [
        ...
        {
          "content": "13:03 星宸科技发布业绩预告，预计2026年半年度归属于上市公司股东的净利润区间为8.20亿元至9.00亿元，较上年同期增长583.72%至650.42%。\n\n公司表示，业绩增长主要得益于端边侧AI产业需求的快速增长，带动公司产品结构优化，高附加值芯片出货占比提升。同时，公司供应链体系的韧性增强，产能保障能力得到进一步强化。\n\n根据业绩预告推算，公司第二季度净利润预计在6亿元至6.8亿元之间，相较于第一季度的2.2亿元净利润，环比增长幅度预计为172%至208%。",
          "tags": [
            "资讯"
          ]
        }
    ...
    {
      "code": "688401.SH",
      "fetch_time": "2026-07-20T13:21:07+0800",
      "name": "路维光电",
      "pe": 46.1512,
      "pb": 4.8333,
      "ps_ttm": 10.2393,
    ...
    },
    {
      ...
      "events": [
        ...
        {
          "content": "16:47 荣昌生物发布公告，公司拟使用自有资金回购部分股份，回购金额区间为2500万元至5000万元。\n\n本次回购的股份将用于后续实施员工持股计划或股权激励。回购价格上限设定为每股149元。",
          "tags": [
            "资讯"
          ]
        }
    ...
    {
      "code": "605020.SH",
      "fetch_time": "2026-07-20T13:21:09+0800",
      "name": "永和股份",
      "pe": 24.9895,
      "pb": 2.824,
      "ps_ttm": 2.9869,
    ...
    },
    {
      ...
      "events": [
        ...
        {
          "content": "09:36 7月20日早盘，创新药概念板块出现持续调整。昭衍新药连续2个交易日跌停。\n\n此外，哈药股份、灵康药业、津药药业均出现跌停。万邦医药、博瑞医药、常山药业、立方制药、片仔癀跌幅均超过5%。",
          "tags": [
            "资讯"
          ]
        },
  ...
  "entry_regime": {
    ...
    "hard_block": true,
    "reason": "Entry regime panic: breadth 0.68:1, 2/3 major indices green, 57 limit-ups / 81 limit-downs. Block new longs."
  },
  "rule_violations": {
    "status": "ok",
    "total_rules": 6,
