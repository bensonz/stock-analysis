...
### [invariant] daily_summary 声称新开 688222，持仓快照里没有

- `new-position-not-held:688222`
- newPositions 含 688222 (成都先导)，但 positions_snapshot.activePositions 不含该代码。T+1 排除了当日开平的解释——两份产物必然有一份在说谎。
