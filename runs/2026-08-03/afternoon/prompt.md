...
```json
{
  ...
  "portfolio": {
    ...
    "totalEquity": 947110.0,
    "cash": 814240.0,
    "investedValue": 132870.0,
    "unrealizedPnl": 918.0,
    "realizedPnl": -53808.0,
    "totalPnl": -52890.0,
    "totalReturnPct": -5.29,
  ...
  "market": {
    "timestamp": "2026-08-03T16:00:00.391759",
    "indices": {
      "上证指数": {
        "code": "sh000001",
        "close": 3809.663,
  ...
  "enriched_candidates": [
    {
      "code": "603203.SH",
      "fetch_time": "2026-08-03T16:00:00+0800",
      "name": "快克智能",
      "pe": 78.5716,
      "pb": 8.5266,
      "ps_ttm": 10.0709,
      "pcf_ttm": 43.0274,
      "valuation_percentile": 88.8,
      ...
      "events": [
        ...
        {
          "content": "快克智能：快克智能关于2025员工持股计划第一个锁定期届满的提示性公告",
          "tags": [
            "重要公告"
          ]
        }
    ...
    {
      "code": "603162.SH",
      "fetch_time": "2026-08-03T16:00:02+0800",
      "name": "海通发展",
      "pe": 16.2382,
      "pb": 3.0045,
      "ps_ttm": 2.3949,
    ...
    {
      "code": "002138.SZ",
      "fetch_time": "2026-08-03T16:00:04+0800",
      "name": "顺络电子",
      "pe": 35.7174,
      "pb": 5.3441,
      "ps_ttm": 4.7541,
  ...
  "active_positions": [
    {
      ...
      "history": [
        ...
        },
        {
          ...
          "change_pct": 4.04,
          "action": "HOLD",
          "note": "+4.04% in 4 days, thesis intact (H1净利+2326-2547%, 文莱炼化, 10亿回购). Sector 石油石化 mid-pack — benefiting from rotation out of tech. Stop at 14.82 safe (8.7% cushion). 4 days held — far from 10-day time stop. Margin signal neutral."
        }
      ]
    },
    {
      ...
      "history": [
        ...
        },
        {
          ...
          "change_pct": -2.9,
          "action": "HOLD",
          "note": "-2.90% in 3 days — close to -3% rule but not breached. MLCC catalyst is FRESH: Samsung 8/1涨价30% just took effect, 太阳诱电 9/1跟进. Structural sector catalyst, not a one-day headline. Margin signal 'adding' (+7.22% 5d) — leveraged buyers accumulating. Stock stabilized today (+0.04%). Give 1-2 more days for catalyst to price in. NOTE: current stop 103.45 (-10.1%) is too loose per V2 -5% rule; correct stop would be 109.32."
        }
      ]
    },
    {
      ...
      "history": [
        ...
        },
        {
          ...
          "change_pct": 0.63,
          "action": "HOLD",
          "note": "+0.63% from entry. 中报 tomorrow (8/4) — key binary catalyst. VCP SETUP: price within 2.2% of MA10, classic coil-before-catalyst pattern. Consensus ~131.5B Q2 revenue. 0 risk tags, 10亿回购, A/H折价-7%. Stop at 120.18 (exactly -5%) is properly set. If 中报 beats, gap-up potential; if misses, stop fires. Event does not override stop."
        }
      ]
    }
  ],
  ...
  "iv_sentiment": {
    ...
    "etf_iv_data": [
      ...
      },
      {
        ...
        "iv_rank": 0.7593,
        "iv_rank_raw": 0.6044,
        "iv_percentile": 0.8756,
        "iv_percentile_raw": 0.8571,
        "outliers_removed": 7,
        "outlier_details": [
          {
            "date": "2025-08-15",
      ...
      },
      {
        ...
        "iv_rank": 0.9195,
        "iv_rank_raw": 0.6081,
        "iv_percentile": 0.9677,
        "iv_percentile_raw": 0.9502,
        "outliers_removed": 4,
        "outlier_details": [
          {
            "date": "2025-09-05",
      ...
      },
      {
        ...
        "iv_rank": 0.8895,
        "iv_rank_raw": 0.5306,
        "iv_percentile": 0.9575,
        "iv_percentile_raw": 0.9186,
        "outliers_removed": 9,
        "outlier_details": [
          {
            "date": "2025-09-04",
      ...
      },
      {
        ...
        "iv_rank": 0.6896,
        "iv_rank_raw": 0.4145,
        "iv_percentile": 0.8465,
        "iv_percentile_raw": 0.8235,
        "outliers_removed": 6,
        "outlier_details": [
          {
            "date": "2025-08-18",
      ...
      },
      {
        ...
        "iv_rank": 0.894,
        "iv_rank_raw": 0.546,
        "iv_percentile": 0.9491,
        "iv_percentile_raw": 0.9276,
        "outliers_removed": 5,
        "outlier_details": [
          {
            "date": "2025-08-20",
  ...
  "entry_regime": {
    ...
    "hard_block": false,
    "reason": "Entry regime balanced: breadth 2.73:1, 0/3 major indices green, 83 limit-ups / 9 limit-downs. Allow normal sizing."
  },
  "rule_violations": {
    "status": "ok",
    "total_rules": 6,
