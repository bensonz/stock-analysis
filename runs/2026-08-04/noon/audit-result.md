...
### [invariant] daily_summary 声称新开 000739，持仓快照里没有

- `new-position-not-held:000739`
- newPositions 含 000739 (普洛药业)，但 positions_snapshot.activePositions 不含该代码。T+1 排除了当日开平的解释——两份产物必然有一份在说谎。
